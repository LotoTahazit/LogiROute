...
class _InventoryReportScreenState extends State<InventoryReportScreen> {
  ...
  String _localizeAction(String action, AppLocalizations l10n) {
    switch (action) {
      case 'add':
        return l10n.inventoryActionAdd;
      case 'deduct':
  ...
  String _localizeReason(String reason, AppLocalizations l10n) {
    switch (reason) {
      case 'order_creation':
        return l10n.deductionForOrderReason;
      // Legacy: already-localized strings from old records — show as-is
      default:
        return reason;
    }
  }
                          ...
                          if (snapshot.hasData && snapshot.data != null) {
                            ...
                            final totalAdded = filtered
                                ...
                                .fold(
                                    0,
                                    (runningTotal, c) =>
                                        runningTotal + c.quantityChange);
                            final totalDeducted = filtered
                                .where((c) => c.quantityChange < 0)
                                .fold(
                                  0,
                                  (runningTotal, c) =>
                                      runningTotal + c.quantityChange.abs(),
                                );
                              ...
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${_localizeAction(change.action, l10n)}: ${isAddition ? '+' : ''}${change.quantityChange} ${l10n.units}',
                                      style: TextStyle(
                                        color: color,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 16,
                                    ...
                                    if (change.reason != null)
                                      Text(
                                        '${l10n.reason}: ${_localizeReason(change.reason!, l10n)}',
                                        style: const TextStyle(
                                          fontSize: 12,
