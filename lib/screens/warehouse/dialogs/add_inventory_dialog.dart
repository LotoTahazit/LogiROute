  ...
  void _searchByProductCode(String searchText) {
    ...
    try {
      ...
      setState(() {
        ...
        _volumeMl = (item['volumeMl'] as num?)?.toInt();
        _quantityPerPallet = (item['quantityPerPallet'] as num?)?.toInt();
        _diameter = item['diameter'] as String?;
        _piecesPerBox = (item['piecesPerBox'] as num?)?.toInt();
              ...
              onChanged: (value) {
                setState(() {
                  ...
                  if (value != null) {
                    ...
                    _volumeMl = (item['volumeMl'] as num?)?.toInt();
                    _quantityPerPallet =
                        (item['quantityPerPallet'] as num?)?.toInt();
                    _diameter = item['diameter'] as String?;
                    _piecesPerBox = (item['piecesPerBox'] as num?)?.toInt();
                    _additionalInfo = item['additionalInfo'] as String?;
                  }
