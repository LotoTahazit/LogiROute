...
class _ProductManagementScreenState extends State<ProductManagementScreen> {
          ...
          onSelected: (value) async {
            if (value == 'edit') {
              ...
              final confirmed = await DialogHelper.showConfirmation(
                ...
                content: l10n.permanentDeleteConfirm(product.name),
              );
              if (confirmed == true) {
        ...
        if (context.mounted) {
          ...
          if (msg.contains('DUPLICATE_PRODUCT_CODE')) {
            SnackbarHelper.showError(
              context,
              l10n.duplicateProductCode(result.productCode),
            );
          } else {
  ...
  Future<void> _syncFromInventory(
    ...
    final confirmed = await DialogHelper.showConfirmation(
      context: context,
      title: l10n.syncFromWarehouseTitle,
      content: l10n.syncFromWarehouseConfirm,
    );
