  ...
  Future<void> _load() async {
    ...
    try {
      ...
      setState(() {
        ...
        _gracePeriodDays = (data['gracePeriodDays'] as num?)?.toInt() ?? 7;
    ...
    try {
      ...
      if (uid.isNotEmpty) {
        ...
        if (_trialUntil != _prevTrialUntil) {
          audit.log(
            moduleKey: 'accounting',
            type: CrossModuleAuditService.typeTrialUntilChanged,
            entityCollection: 'billing',
            entityDocId: _companyId!,
            uid: uid,
          );
        ...
        if (_accountingLockedUntil != _prevAccountingLockedUntil) {
          audit.log(
            moduleKey: 'accounting',
            type: CrossModuleAuditService.typeAccountingLockedUntilChanged,
            entityCollection: 'billing',
            entityDocId: _companyId!,
            uid: uid,
          );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          initialValue: _statuses.contains(_billingStatus)
                              ? _billingStatus
                              : 'active',
                          items: _statuses
