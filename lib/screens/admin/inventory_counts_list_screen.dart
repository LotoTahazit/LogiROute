...
class InventoryCountsListScreen extends StatelessWidget {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildCountCard(
                  context, count, l10n, counts.length - index);
            },
          );
        },
      ),
  ...
  Widget _buildCountCard(BuildContext context, InventoryCount count,
      AppLocalizations l10n, int number) {
                ...
                children: [
                  ...
                  ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${l10n.inventoryCount} #$number — ${dateFormat.format(count.startedAt)}',
