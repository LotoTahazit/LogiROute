...
class CountSummary {
  ...
  factory CountSummary.fromMap(Map<String, dynamic> map) {
    return CountSummary(
      ...
      checkedItems: (map['checkedItems'] as num).toInt(),
      itemsWithDifference: (map['itemsWithDifference'] as num).toInt(),
      totalShortage: (map['totalShortage'] as num).toInt(),
      totalSurplus: (map['totalSurplus'] as num).toInt(),
    );
  }
