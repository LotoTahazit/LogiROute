...
exports.sendEmailNotification = functions.firestore
  ...
  .onCreate(async (snap, context) => {
    ...
    try {
      // Get SMTP config: first try company integrations, then env
      ...
      if (emailCfg.enabled && emailCfg.smtpHost && emailCfg.smtpUser) {
        ...
        console.log(`📧 Using company SMTP for ${companyId}: ${smtpHost}`);
      } else {
        ...
        console.log(`📧 Using global SMTP for ${companyId}`);
      }
